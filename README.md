# vibrant-hair-salon-landing

Create a landing page for a haridresser salsing. Use image for hero. And create 3-4 sections for it with dummy content
...
```sh
git clone https://github.com/GPT-Engineer-App/vibrant-hair-salon-landing.git
cd vibrant-hair-salon-landing
npm i
```
